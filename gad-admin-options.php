...
class GADAdminOptions {
	...
	function admin_plugin_options( $info_message = '' ) {
		if ( ! class_exists( 'SimpleXMLElement' ) ) {
			echo '<br/><br/><div id="message" class="updated fade"><p><strong>' . __( 'It appears that <a href="http://us3.php.net/manual/en/book.simplexml.php">SimpleXML</a> is not compiled into your version of PHP. It is required for this plugin to function correctly.', 'google-analytics-dashboard' ) . '</strong></p></div>';
		} else {
			if ( ! function_exists( 'curl_init' ) ) {
				echo '<br/><br/><div id="message" class="updated fade"><p><strong>' . __( 'It appears that <a href="http://www.php.net/manual/en/book.curl.php">CURL</a> is not compiled into your version of PHP. It is required for this plugin to function correctly.', 'google-analytics-dashboard' ) . '</strong></p></div>';
			} else {
